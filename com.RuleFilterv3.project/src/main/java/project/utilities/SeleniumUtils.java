...
public void moveToElement(String xpath){
	...
	public void scrollToColumn(String sTag, String sColumn) {

		SeleniumUtils.defaultWait(ProjectVariables.MID_TIME_OUT);

		WebElement oColoumn = getDriver().findElement(By.xpath("//" + sTag + "[text()='" + sColumn + "']"));

		if (!oColoumn.isDisplayed()) {

			WebElement horizontal_scroll = getDriver().findElement(By.xpath("//" + sTag + "[text()='" + sColumn + "']"));
